...
class IngestaDatos:
    ...
    @classmethod
    def crear_visitantes(cls):
        """Crea todos los visitantes predefinidos"""
        print(f"\n{'='*50}")
        print(f"Creando {len(cls.VISITANTES)} visitantes...")
        print(f"{'='*50}")
        
        visitantes = []
        
        for i, v_data in enumerate(cls.VISITANTES):
    ...
    @classmethod
    def crear_atracciones(cls):
        """Crea todas las atracciones predefinidas"""
        print(f"\n{'='*50}")
        print(f"Creando {len(cls.ATRACCIONES)} atracciones...")
        print(f"{'='*50}")
        
        atracciones = []
        
        for i, a_data in enumerate(cls.ATRACCIONES):
    ...
    @classmethod
    def crear_tickets(cls, visitantes, atracciones, tickets_por_visitante=2):
        ...
        tickets = []
        ticket_count = 0
        tipos_ticket = list(cls.TICKETS_CONFIG.keys())
        ...
        for visitante in visitantes:
            ...
            for _ in range(num_tickets):
                ...
                config = cls.TICKETS_CONFIG[tipo_ticket]
    ...
    @classmethod
    def ingesta_completa(cls, tickets_por_visitante=2):
        ...
        # Crear visitantes
        visitantes = cls.crear_visitantes()
        
        # Crear atracciones
        atracciones = cls.crear_atracciones()
        
        # Crear tickets
        tickets = cls.crear_tickets(visitantes, atracciones, tickets_por_visitante)
...
if __name__ == "__main__":
    resultados = IngestaDatos.ingesta_completa(tickets_por_visitante=3)